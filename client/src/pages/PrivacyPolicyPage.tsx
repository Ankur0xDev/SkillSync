      ...
      <div className={`ml-64 py-12 px-8 ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className={`text-4xl font-bold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} mb-4`}>Privacy Policy</h1>
          ...
          <div id="information" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8 mb-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <Database className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Information We Collect</h2>
              </div>
              <button
            ...
            {expandedSections.has('information') && (
              <div className="space-y-4">
                <div>
                  <h3 className={`text-lg font-medium ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} mb-2`}>Personal Information</h3>
                ...
                <div>
                  <h3 className={`text-lg font-medium ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} mb-2`}>Usage Information</h3>
                  <ul className={`list-disc list-inside ${theme === 'dark' ? 'text-gray-100' : 'text-gray-600'} space-y-2`}>
          ...
          <div id="usage" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8 mb-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <Eye className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>How We Use Your Information</h2>
              </div>
              <button
          ...
          {/* Data Security */}
          <div id="security" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8 mb-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <Lock className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Data Security</h2>
              </div>
              <button
          ...
          {/* User Rights */}
          <div id="rights" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8 mb-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <UserCheck className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Your Rights</h2>
              </div>
              <button
          ...
          {/* Terms of Use */}
          <div id="terms" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8 mb-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <Shield className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Terms of Use</h2>
              </div>
              <button
          ...
          {/* Cookies Policy */}
          <div id="cookies" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8 mb-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <Cookie className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Cookies Policy</h2>
              </div>
              <button
            ...
            {expandedSections.has('cookies') && (
              <div className="space-y-4">
                ...
                <p className={`${theme === 'dark' ? 'text-gray-100' : 'text-gray-600'} mt-4`}>
          ...
          <div id="international" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8 mb-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <Globe className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>International Data Transfers</h2>
              </div>
              <button
          ...
          {/* Important Notices */}
          <div id="notices" className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-sm p-8`}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <AlertTriangle className="w-6 h-6 text-purple-600" />
                <h2 className={`text-2xl font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}>Important Notices</h2>
              </div>
              <button
            ...
            {expandedSections.has('notices') && (
              <div className="space-y-4">
                <div>
                  <h3 className={`text-lg font-medium ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} mb-2`}>Changes to This Policy</h3>
                  <p className={`${theme === 'dark' ? 'text-gray-100' : 'text-gray-600'}`}>
